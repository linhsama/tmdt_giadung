...
$id_th = $_POST['id_th'];
$thuongHieu__Get_By_Id = $th->ThuongHieu__Get_By_Id($id_th);
?>
...
<div class="main-update">
    ...
    <form class="form-group" action="pages/thuong-hieu/action.php?req=update" method="post">
        <input type="hidden" class="form-control" id="id_th" name="id_th" required value="<?= $thuongHieu__Get_By_Id->id_th ?>" readonly>
        <div class="col">
