                            ...
                            <?php foreach ($thuongHieu__Get_All as $item) : ?>
                                <tr>
                                    ...
                                    <td class="text-center font-weight-bold">
                                        <button type="button" class="btn btn-warning btn-update" onclick="return update_obj('<?= $item->id_th ?>')">
                                            <i class="bx bx-edit" aria-hidden="true"></i> Sửa
                                        </button>
                                        <?php if (isset($_SESSION['admin'])) : ?>
                                            <!-- <button type="button" class="btn btn-danger btn-delete" onclick="return delete_obj('<?= $item->id_th ?>')">
    ...
    function delete_obj(id_th) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                location.href = "pages/thuong-hieu/action.php?req=delete&math=" + id_th;
            } else if (
