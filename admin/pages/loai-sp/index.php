                            ...
                            <?php foreach ($loaisp__Get_All as $item) : ?>
                                <tr>
                                    ...
                                    <td class="text-center font-weight-bold">
                                        <button type="button" class="btn btn-warning btn-update" onclick="return update_obj('<?= $item->id_loai ?>')">
                                            <i class="bx bx-edit" aria-hidden="true"></i> Sửa
                                        </button>
                                        <?php if (isset($_SESSION['admin'])) : ?>
                                            <!-- <button type="button" class="btn btn-danger btn-delete" onclick="return delete_obj('<?= $item->id_loai ?>')">
    ...
    function delete_obj(id_loai) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                location.href = "pages/loai-sp/action.php?req=delete&id_loai=" + id_loai;
            } else if (
