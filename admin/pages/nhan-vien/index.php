                            ...
                            <?php foreach ($nhanVien__Get_All as $item) : ?>
                                <tr>
                                    ...
                                    <td class="text-center font-weight-bold">
                                        <button type="button" class="btn btn-warning btn-update" onclick="return update_obj('<?= $item->id_nv ?>')">
                                            <i class="bx bx-edit" aria-hidden="true"></i> Sửa
                                        </button>
                                        <?php if (isset($_SESSION['admin'])) : ?>
                                            <!-- <button type="button" class="btn btn-danger btn-delete" onclick="return delete_obj('<?= $item->id_nv ?>')">
    ...
    function delete_obj(id_nv) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                location.href = "pages/nhan-vien/action.php?req=delete&manv=" + id_nv;
            } else if (
