                    ...
                    <table id="table_js" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><p class="text_over"><?= $item->tensp ?></p></td>
                                <td><?=  number_format($dg->Dongia__Get_By_Id_Sp_First($item->id_sp)->giatri) ?></td>
                                ...
                                <td class="text-center font-weight-bold">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning btn-update"
                                        onclick="return update_sp_obj('<?= $item->id_sp ?>')">
                                        <i class="bx bx-edit" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-success btn-update"
                                        onclick="return view_obj('<?= $item->id_sp ?>', '<?= $item->tensp ?>')">
...
function view_obj(id_sp, tensp) {
    $.post("pages/san-pham/dongia.php", {
        id_sp: id_sp,
        tensp: tensp
