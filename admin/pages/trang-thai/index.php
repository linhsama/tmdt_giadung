                            ...
                            <?php foreach ($trangThai__Get_All as $item) : ?>
                                <tr>
                                    ...
                                    <td class="text-center font-weight-bold">
                                        <button type="button" class="btn btn-warning btn-update" onclick="return update_obj('<?= $item->id_tt ?>')">
                                            <i class="bx bx-edit" aria-hidden="true"></i> Sửa
                                        </button>
                                        <?php if (isset($_SESSION['admin'])) : ?>
                                            <!-- <button type="button" class="btn btn-danger btn-delete" onclick="return delete_obj('<?= $item->id_tt ?>')">
    ...
    function delete_obj(id_tt) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                location.href = "pages/trang-thai/action.php?req=delete&id_tt=" + id_tt;
            } else if (
