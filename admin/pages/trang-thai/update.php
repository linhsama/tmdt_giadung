...
$id_tt = $_POST['id_tt'];
$trangThai__Get_By_Id = $tt->TrangThai__Get_By_Id($id_tt);
?>
...
<div class="main-update">
    ...
    <form class="form-group" action="pages/trang-thai/action.php?req=update" method="post">
        <input type="hidden" class="form-control" id="id_tt" name="id_tt" required value="<?= $trangThai__Get_By_Id->id_tt ?>" readonly>
        <div class="col">
