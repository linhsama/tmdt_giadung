    ...
    <div class="navbar-container">
        ...
        <div class="navbar-logo-menu">
            ...
            <a class="navbar-logo" href="./index.php">
                <img alt="logo" src="../assets/images/ong2.png" width="100">
            </a>
                    ...
                    <ul class="navbar-item-sub">
                        <div class="menu-country">
                            <?php foreach ($thuongHieu__Get_All as $item) : ?>
                                <li><a href="index.php?pages=thuong-hieu&id_th=<?= $item->id_th ?>"><?= $item->tenth ?></a></li>
                            <?php endforeach ?>
                        </div>
                        <div class="menu-genre">
                            <?php foreach ($loaiSp__Get_All as $item) : ?>
                                <li>
                                    <a href="index.php?pages=loai-sp&id_loai=<?= $item->id_loai ?>">
                                        <?= $item->tenloai ?>
                                    </a>
                                </li>
                            <?php endforeach ?>
                ...
                <div class="navbar-display-cart" onclick="return(location.href='./index.php?pages=gio-hang')">
                    <i class='bx bxs-cart'>
                        ...
                        if (isset($_SESSION['user'])) {
                            $id_gh = isset($gh->GioHang__Get_By_Id_Kh($_SESSION['user']->id_kh)->id_gh) ? $gh->GioHang__Get_By_Id_Kh($_SESSION['user']->id_kh)->id_gh : 0;
                            $res = count($ctgh->ChiTietGioHang__Get_By_Id_GH($id_gh));
                        }
                        ?>
