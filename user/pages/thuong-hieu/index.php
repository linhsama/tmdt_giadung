...
$id_th = isset($_GET['id_th']) ? intval($_GET['id_th']) : 1;
$page_number = isset($_GET['page']) ? intval($_GET['page']) : 1;

// Lấy danh sách truyện cho trang hiện tại
$sanPham__Get_By_Th_Paged = $sp->SanPham__Get_By_Th_Paged($page_number, $id_th);
?>
    ...
    <div class="main-container">
        <div class="main-title-container">
            <a href="index.php?pages=danh-muc">
                <div class="item-title color-2"><i class='bx bx-star bx-tada'></i>Thương hiệu <?=$th->ThuongHieu__Get_By_Id($id_th)->tenth?> </div>
            </a>
        </div>
