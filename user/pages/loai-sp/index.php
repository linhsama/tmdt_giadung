...
$id_loai = isset($_GET['id_loai']) ? intval($_GET['id_loai']) : 1;
$page_number = isset($_GET['page']) ? intval($_GET['page']) : 1;

// Lấy danh sách truyện cho trang hiện tại
$sanPham__Get_By_Loai_Paged = $sp->SanPham__Get_By_Loai_Paged($page_number, $id_loai);
?>
    ...
    <div class="main-container">
        <div class="main-title-container">
            <a href="index.php?pages=danh-muc">
                <div class="item-title color-2"><i class='bx bx-star bx-tada'></i>Sản phẩm loại <?=$loaiSp->LoaiSp__Get_By_Id($id_loai)->tenloai?> </div>
            </a>
        </div>
