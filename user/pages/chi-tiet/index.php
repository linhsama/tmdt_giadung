...
$sp__Get_By_Id = $sp->SanPham__Get_By_Id($id_sp);
$sp__Get_Top_Sale = $sp->SanPham__Get_Top_Sale();
$sp__Get_Top_Same = $sp->SanPham__Get_Top_Same($sp__Get_By_Id->id_th,  $id_sp);
$anhSp__Get_By_Id_Sp_Not_First = $anhSp->AnhSp__Get_By_Id_Sp_Not_First($sp__Get_By_Id->id_sp);
?>
<main class="main">
                ...
                <div class="manga-sp-container__chitiet__left">
                    ...
                    <div class="sp-container__top">
                        <div class="tab-group-1">
                            <h5 class="text-danger"><b><?= number_format($dg->Dongia__Get_By_Id_Sp_First($sp__Get_By_Id->id_sp)->giatri) ?>đ</b></h5>
                        </div>
                        <div class="sp-item-container__chitiet__left">
                            <div class="tab-group-1">
                                <div class="sp-thich">
                                    <?php if(isset($_SESSION['user'])):?>
                                    <div class="btn btn-sm color-0 background-7" onclick="addCart('<?= $id_sp ?>')">
                ...
                <div class="manga-sp-container__chitiet__bottom">
                    ...
                    <div class="chapter-container__chitiet__bottom__noi_dung">
                        <?php if ($sp__Get_By_Id->mota != "") : ?>
                            <?= $sp__Get_By_Id->mota ?>
                        <?php else : ?>
                            <a href="index.php?pages=sp-chi-tiet&id_sp=<?= $item->id_sp ?>">
            ...
            <div class="main-item-container__right">
                <?php foreach ($sp__Get_Top_Sale as $item) : ?>
                    <?php if (count($sp__Get_Top_Sale) > 0) : ?>
                        <?php $anhSp__Get_By_Id_Sp_First = $anhSp->AnhSp__Get_By_Id_Sp_First($item->id_sp); ?>
                        <?php if (isset($anhSp__Get_By_Id_Sp_First->id_sp)) : ?>
                            <a href="index.php?pages=chi-tiet&id_sp=<?= $item->id_sp ?>">
                    ...
                    <?php if (isset($anhSp__Get_By_Id_Sp_First->id_sp)) : ?>
                        <a href="index.php?pages=chi-tiet&id_sp=<?= $item->id_sp ?>">
                            <div class="manga-container">
                                <div class="manga-thumbnail">
                                    <img src="../assets/<?= $anhSp__Get_By_Id_Sp_First->hinhanh ?>">
                                    <span class="manga-note background-8"><?= number_format($item->giatri) ?>đ</i></span>
                                </div>
